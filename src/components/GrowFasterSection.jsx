...
const GrowFasterSection = () => {
  return (
    <div className='w-full py-10 bg-primary'>
      <div className="md:w-3/4 mx-auto px-2 flex flex-col md:flex-row items-start md:justify-between md:items-center gap-4">
        <div>
          <h4 className="text-white text-2xl font-bold mb-4">Grow Faster with Cogoport</h4>
          <p className="text-white">Know more about Cogoport’s Global Trade PlatformTM</p>
        </div>
        <button className="bg-secondary font-bold py-2 px-4 rounded inline">
