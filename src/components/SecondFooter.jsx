...
const SecondFooter = () => {
  return (
    <div className='bg-[#EBBE00] px-4 md:px-12 py-4 md:py-12'>
      <div className="hidden md:grid grid-cols-3 mb-8 gap-40">
        <div className="grid grid-cols-1 gap-3">
          <a href="" className="hover:text-primary hover:underline">Kolkata to Savannah, Georgia</a>
          <a href="" className="hover:text-primary hover:underline">Kolkata to Sand Point</a>
          <a href="" className="hover:text-primary hover:underline">Bilbao to Kolkata</a>
          <a href="" className="hover:text-primary hover:underline">New York to Kolkata</a>
          <a href="" className="hover:text-primary hover:underline">Los Angeles to Kolkata</a>
          <a href="" className="hover:text-primary hover:underline">Suzhou to Kolkata</a>
          <a href="" className="hover:text-primary hover:underline">Xingang to Kolkata</a>
          <a href="" className="hover:text-primary hover:underline">Kolkata to Ajman</a>
          <a href="" className="hover:text-primary hover:underline">Kolkata to New York</a>
          <a href="" className="hover:text-primary hover:underline">Gdansk to Kolkata</a>
        </div>
        <div className="grid grid-cols-1 gap-3">
          <a href="" className="hover:text-primary hover:underline">Kolkata to Savannah, Georgia</a>
          <a href="" className="hover:text-primary hover:underline">Kolkata to Sand Point</a>
      ...
      <div className="flex flex-col md:flex-row md:justify-between">
        <div className="order-last md:order-first flex">
          <span className="text-xs md:font-bold md:me-8">© 2023 Cogo Universe PTE. All rights reserved.</span>
          <span className="hidden md:inline text-xs font-bold">
            <a href="" className="hover:underline">Terms and Conditions</a>
            <span className="mx-1">|</span>
            <a href="" className="hover:underline">Cookie Policy</a>
            <span className="mx-1">|</span>
            <a href="" className="hover:underline">Privacy and Data Protection Policy</a>
          </span>
        </div>
        <div className="flex justify-start md:justify-end items-center mb-2 md:mb-0">
          <a href="" className="text-primary font-bold underline md:me-8 order-last md:order-first">English (IN)</a>
