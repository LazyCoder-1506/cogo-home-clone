...
const FixedWhatsappButton = () => {
  ...
  const handleScroll = () => {
    ...
    if (screenWidth >= 768 && position > 300) {
      setShowButton(true);
    } else {
      setShowButton(false)
    }
